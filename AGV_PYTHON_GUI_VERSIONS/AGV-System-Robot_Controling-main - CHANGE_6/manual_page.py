...
class ManualPage(ctk.CTkFrame):
    ...
    def show_charge_section(self):
        ...
        self.charge_entry = ctk.CTkEntry(
            self.section_frame, width=100, placeholder_text="0"
        )
    ...
    def show_trip_section(self):
        ...
        self.show_bottom_buttons(["Home", "Start"], mode="Trip")
